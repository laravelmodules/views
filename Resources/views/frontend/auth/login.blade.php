            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        {{ Form::label('login', trans('validation.attributes.frontend.login'), ['class' => 'col-md-4 control-label']) }}
                        <div class="col-md-6">
                            {{ Form::input('login', 'login', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.frontend.login')]) }}
                        </div><!--col-md-6-->
                    </div><!--form-group-->

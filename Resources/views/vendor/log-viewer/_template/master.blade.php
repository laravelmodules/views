...
<html lang="en">
    ...
    <body class="skin-{{ config('backend.theme') }} {{ config('backend.layout') }}">
        @include('views::includes.partials.logged-in-as')

        <div class="wrapper">
            @include('views::backend.includes.header')
            @include('views::backend.includes.sidebar')
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    @include('views::includes.partials.messages')
                    @yield('content')
                </section><!-- /.content -->
            </div><!-- /.content-wrapper -->

            @include('views::backend.includes.footer')
        </div><!-- ./wrapper -->

                    ...
                    <div role="tabpanel">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane mt-30 active" id="profile">
                                @include('views::dashboard.user.account.tabs.profile')
                            </div><!--tab panel profile-->

                            <div role="tabpanel" class="tab-pane mt-30" id="edit">
                                @include('views::dashboard.user.account.tabs.edit')
                            </div><!--tab panel profile-->

                            @if ($logged_in_user->canChangePassword())
                                <div role="tabpanel" class="tab-pane mt-30" id="password">
                                    @include('views::dashboard.user.account.tabs.change-password')
